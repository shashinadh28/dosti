        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-10">
                ...
                <div className="sm:col-span-2 md:col-span-1 flex flex-col items-center sm:items-start">
                    ...
                    <p className="text-white/40 text-xs leading-relaxed mb-4 text-center sm:text-left">
                ...
                <div className="text-center sm:text-left">
                    ...
                    <ul className="space-y-2.5">
                        {['Direct Hire Solutions', 'Recruitment Expertise', 'Temp-to-Hire', 'Temporary Staffing', 'Executive Search', 'Contract Staffing'].map(l => (
                            <li key={l}>
                                <a href="#" className="text-white/40 text-xs hover:text-[#F5A023] transition-colors leading-relaxed block">{l}</a>
                            </li>
                        ))}
                    </ul>
                </div>
                ...
                <div className="sm:col-span-2 md:col-span-1 text-center sm:text-left">
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="flex items-start gap-2.5 justify-center sm:justify-start">
                            ...
                            <a href="mailto:deepakt@dhostiglobal.com" className="text-white/40 text-xs hover:text-[#F5A023] transition-colors break-all">
